...
public class PartnersController {
     ...
     */
    @PostMapping("")
    public ResponseBean addRecruitment(@RequestBody TpPartnersRequest request) {
     ...
     */
    @PutMapping("")
    public ResponseBean updateRecruitment(@RequestBody TpPartnersRequest request) {
        TpPartnersDTO dto = partnersClassifyService.savePartners(request);
        return ResponseBean.success(dto);
    }
     ...
     */
    @DeleteMapping("/{id}")
    public ResponseBean removePartners(@PathVariable("id") String  id) {
     ...
     */
    @GetMapping("/page")
    public ResponseBean pageRecruitment(TpPartnersRequest request) {
     ...
     */
    @PutMapping("/enable")
    public ResponseBean enableRecruitment(@RequestBody TpPartnersRequest request) {
     ...
     */
    @PutMapping("/top")
    public ResponseBean top(@RequestBody TpPartnersRequest request) {
