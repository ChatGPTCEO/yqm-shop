...
import com.yqm.modules.system.domain.vo.UserPassVo;
import com.yqm.modules.system.service.DeptService;
import com.yqm.modules.system.service.RoleService;
import com.yqm.modules.system.service.UserService;
...
import com.yqm.tools.service.VerificationCodeService;
import com.yqm.utils.PageUtil;
import com.yqm.utils.SecurityUtils;
import com.yqm.utils.YqmShopConstant;
...
public class SysUserController {
    ...
    public ResponseEntity<Object> create(@Validated @RequestBody User resources){
        ...
        // 默认密码 123456
        resources.setPassword(passwordEncoder.encode(ShopConstants.YQM_SHOP_DEFAULT_PWD));
    ...
    public ResponseEntity<Object> updateEmail(@PathVariable String code,@RequestBody User user){
        ...
        VerificationCode verificationCode = new VerificationCode(code, YqmShopConstant.RESET_MAIL,"email",user.getEmail());
