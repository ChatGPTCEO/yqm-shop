 ...
 */
package com.yqm.modules.security.service;

import cn.hutool.core.util.StrUtil;
import com.yqm.constant.ShopConstants;
import com.yqm.modules.security.config.SecurityProperties;
import com.yqm.modules.security.security.vo.JwtUser;
...
public class OnlineUserService {
    ...
    public List<OnlineUser> getAll(String filter, int type) {
        ...
        if (type == 1) {
            keys = redisUtils.scan(ShopConstants.YQM_SHOP_APP_LOGIN_USER + "*");
        } else {
    ...
    public void kickOutT(String key) throws Exception {
        ...
        String keyt = ShopConstants.YQM_SHOP_APP_LOGIN_USER + split[0] + StrUtil.COLON + EncryptUtils.desDecrypt(split[1]);
        redisUtils.del(keyt);
