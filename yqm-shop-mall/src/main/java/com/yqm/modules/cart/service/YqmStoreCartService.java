 ...
 */
package com.yqm.modules.cart.service;
...
* @date 2020-05-12
*/
public interface YqmStoreCartService  extends BaseService<YqmStoreCart>{
    ...
    */
    Map<String,Object> queryAll(YqmStoreCartQueryCriteria criteria, Pageable pageable);

    /**
    * 查询所有数据不分页
    * @param criteria 条件参数
    * @return List<YqmStoreCartDto>
    */
    List<YqmStoreCart> queryAll(YqmStoreCartQueryCriteria criteria);
    ...
    * @throws IOException /
    */
    void download(List<YqmStoreCartDto> all, HttpServletResponse response) throws IOException;
