package com.yqm.modules.cart.vo;
 ...
 */
@Data
@ApiModel(value = "YqmStoreCartQueryVo对象", description = "购物车表查询参数")
public class YqmStoreCartQueryVo implements Serializable {
    ...
    private YqmStoreProductQueryVo productInfo;
