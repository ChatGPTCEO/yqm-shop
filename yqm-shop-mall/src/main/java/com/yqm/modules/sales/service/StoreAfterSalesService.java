package com.yqm.modules.sales.service;
...
public interface StoreAfterSalesService extends BaseService<StoreAfterSales> {
     ...
     * @return
     */
    List<YqmStoreOrderCartInfoVo> checkOrderDetails(String key);
     ...
     */
    Map<String, Object> queryAll(YqmStoreAfterSalesQueryCriteria criteria, Pageable pageable);

    /**
     * 查询所有数据不分页
     * @param criteria 条件参数
     * @return List<YqmStoreAfterSalesDto>
     */
    List<StoreAfterSales> queryAll(YqmStoreAfterSalesQueryCriteria criteria);
     ...
     * @throws IOException /
     */
    void download(List<YqmStoreAfterSalesDto> all, HttpServletResponse response) throws IOException;
}
