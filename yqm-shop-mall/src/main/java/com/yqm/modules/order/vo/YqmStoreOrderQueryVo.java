...
import com.yqm.modules.order.service.dto.StatusDto;
 ...
 */
@Data
@ApiModel(value = "YqmStoreOrderQueryVo对象", description = "订单表查询参数")
public class YqmStoreOrderQueryVo implements Serializable {
