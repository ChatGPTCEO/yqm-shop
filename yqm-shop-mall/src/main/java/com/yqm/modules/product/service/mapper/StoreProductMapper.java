...
*/
@Repository
public interface StoreProductMapper extends CoreMapper<YqmStoreProduct> {
     ...
     * @return
     */
    @Update("update yqm_store_product set stock=stock-#{num}, sales=sales+#{num}" +
    ...
    @Update("update yqm_store_product set is_show = #{status} where id = #{id}")
     ...
     * @return
     */
    @Update("update yqm_store_combination set stock=stock-#{num}, sales=sales+#{num}" +
     ...
     * @return
     */
    @Update("update yqm_store_seckill set stock=stock-#{num}, sales=sales+#{num}" +
            " where id=#{activityId} and stock >= #{num}")
