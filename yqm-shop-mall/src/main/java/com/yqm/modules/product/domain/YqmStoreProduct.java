...
@TableName("yqm_store_product")
@Builder
@AllArgsConstructor
@NoArgsConstructor
@Getter
@Setter
public class YqmStoreProduct extends BaseDomain {
    ...
    private YqmStoreCategory storeCategory;


    public void copy(YqmStoreProduct source){
