    ...
    public String renotify(@RequestBody String xmlData) {
        try {
            ...
            if(BillDetailEnum.TYPE_3.getValue().equals(attach)){
                YqmStoreOrderQueryVo orderInfo = orderService.getOrderInfo(orderId,null);
                if(orderInfo == null) {
                ...
                //处理充值
                YqmUserRecharge userRecharge = userRechargeService.getInfoByOrderId(orderId);
