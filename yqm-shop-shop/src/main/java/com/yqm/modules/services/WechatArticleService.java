...
import com.yqm.modules.mp.utils.URLUtils;
...
public class WechatArticleService {
    ...
    /**
     * 发布微信图文
     * @param wxNewsArticleItem YqmArticleDto
     * @throws WxErrorException
     */
    public void publish(YqmArticleDto wxNewsArticleItem) throws WxErrorException {
